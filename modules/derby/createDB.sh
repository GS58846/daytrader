...
export CLASSPATH=${G_PATH}/derby/10.1.3.1/derby-10.1.3.1.jar
export CLASSPATH=${CLASSPATH}:${G_PATH}/derbynet/10.1.3.1/derbynet-10.1.3.1.jar
export CLASSPATH=${CLASSPATH}:${G_PATH}/derbytools/10.1.3.1/derbytools-10.1.3.1.jar
export CLASSPATH=${CLASSPATH}:${G_PATH}/derbyclient/10.1.3.1/derbyclient-10.1.3.1.jar
export
