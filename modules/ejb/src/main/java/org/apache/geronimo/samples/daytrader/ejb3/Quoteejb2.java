...
@Entity
@Table(name = "QUOTEEJB")
public class Quoteejb2 implements Serializable {
     ...
     */
    public Quoteejb2(String symbol) {
        this.symbol = symbol;
    }
     ...
     */
    public Quoteejb2(String symbol, double volume, double change1) {
        this.symbol = symbol;
        this.volume = volume;
        this.change = change1;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Quoteejb2)) {
            return false;
        }
        Quoteejb2 other = (Quoteejb2)object;
    ...
    public String toString() {
        return "org.apache.geronimo.samples.daytrader.ejb3.Quoteejb2[symbol=" + symbol + "]";
    }
